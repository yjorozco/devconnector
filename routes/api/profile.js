...
router.get('/github/:username', (req, res) => {
  try {
    ...
    const githubClient = config.get('githubClientId');

    const option = {
      uri: `https//api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:asc&client_id=${githubClient}&client_secret=${githubSecret}`,
      method: 'GET',
